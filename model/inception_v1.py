...
from .depreciated_utils import obtain_input_shape
...
def InceptionV1(include_top=True,
    ...
    x = MaxPooling2D((3, 3), strides=(2, 2), padding='same', name='MaxPool_4b_3x3')(x)
...
if __name__ == '__main__':
    model = InceptionV1(include_top=False, weights='imagenet', input_shape=(512, 512, 3))
    model.summary()
